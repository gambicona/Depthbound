...
let travelMapPan = null;
let travelMapZoom = 1;
let travelMapAnimating = false;
let suppressNextTravelHexClick = false;
...
const els = {
  ...
  readComicMenu: document.querySelector("#read-comic-menu"),
  comicsPanel: document.querySelector("#main-comics"),
  ...
  campMainActions: document.querySelector("#camp-main-actions"),
  campHomeKicker: document.querySelector("#camp-home-kicker"),
  campHomeLocation: document.querySelector("#camp-home-location"),
  campHomeDetails: document.querySelector("#camp-home-details"),
  campHomeTents: document.querySelector("#camp-home-tents"),
  campHomeRations: document.querySelector("#camp-home-rations"),
  campHomeMeal: document.querySelector("#camp-home-meal"),
  campHomeUseRations: document.querySelector("#camp-home-use-rations"),
  campHomeForage: document.querySelector("#camp-home-forage"),
  campHomeHungryRest: document.querySelector("#camp-home-hungry-rest"),
  campHomeBuildRoad: document.querySelector("#camp-home-build-road"),
  campHomeClearRoadDanger: document.querySelector("#camp-home-clear-road-danger"),
  campHomeReviewRoute: document.querySelector("#camp-home-review-route"),
  campHomeLongRest: document.querySelector("#camp-home-long-rest"),
  campHomeExploreHere: document.querySelector("#camp-home-explore-here"),
  campHomeVentureOffTrack: document.querySelector("#camp-home-venture-off-track"),
  campHomeContinue: document.querySelector("#camp-home-continue"),
  ...
  campGearActions: document.querySelector("#camp-gear-actions"),
  goVillage: document.querySelector("#go-village"),
  goTravel: document.querySelector("#go-travel"),
  goAdventure: document.querySelector("#go-adventure"),
  travelMapMenu: document.querySelector("#travel-map-menu"),
  travelMapGrid: document.querySelector("#travel-map-grid"),
  travelMapScroll: document.querySelector("#travel-map-scroll"),
  travelMapTooltip: document.querySelector("#travel-map-tooltip-content"),
  travelMapEvent: document.querySelector("#travel-map-event"),
  travelMapEventKicker: document.querySelector("#travel-map-event-kicker"),
  travelMapEventTitle: document.querySelector("#travel-map-event-title"),
  travelMapEventMessage: document.querySelector("#travel-map-event-message"),
  travelMapEventActions: document.querySelector("#travel-map-event-actions"),
  travelCurrentLabel: document.querySelector("#travel-current-label"),
  travelHomeLabel: document.querySelector("#travel-home-label"),
  travelRouteLabel: document.querySelector("#travel-route-label"),
  travelZoomOut: document.querySelector("#travel-zoom-out"),
  travelZoomIn: document.querySelector("#travel-zoom-in"),
  travelZoomLabel: document.querySelector("#travel-zoom-label"),
  travelZoomSlider: document.querySelector("#travel-zoom-slider"),
  travelGenerateChunks: document.querySelector("#travel-generate-chunks"),
  travelConfirmRoute: document.querySelector("#travel-confirm-route"),
  travelStartRoute: document.querySelector("#travel-start-route"),
  closeTravelMap: document.querySelector("#close-travel-map"),
  travelClearRoute: document.querySelector("#travel-clear-route"),
  travelCampMenu: document.querySelector("#travel-camp-menu"),
  travelCampLocation: document.querySelector("#travel-camp-location"),
  travelCampKicker: document.querySelector("#travel-camp-kicker"),
  travelCampDetails: document.querySelector("#travel-camp-details"),
  travelCampTents: document.querySelector("#travel-camp-tents"),
  travelCampRations: document.querySelector("#travel-camp-rations"),
  travelCampMeal: document.querySelector("#travel-camp-meal"),
  travelCampUseRations: document.querySelector("#travel-camp-use-rations"),
  travelCampForage: document.querySelector("#travel-camp-forage"),
  travelCampHungryRest: document.querySelector("#travel-camp-hungry-rest"),
  travelCampBuildRoad: document.querySelector("#travel-camp-build-road"),
  travelCampClearRoadDanger: document.querySelector("#travel-camp-clear-road-danger"),
  travelCampReviewRoute: document.querySelector("#travel-camp-review-route"),
  travelCampLongRest: document.querySelector("#travel-camp-long-rest"),
  travelCampExploreHere: document.querySelector("#travel-camp-explore-here"),
  travelCampVentureOffTrack: document.querySelector("#travel-camp-venture-off-track"),
  travelCampContinue: document.querySelector("#travel-camp-continue"),
  closeTravelCamp: document.querySelector("#close-travel-camp"),
  ...
  comicReader: document.querySelector("#comic-reader"),
  comicReaderKicker: document.querySelector("#comic-reader-kicker"),
  comicReaderTitle: document.querySelector("#comic-reader-title"),
  comicPageStage: document.querySelector("#comic-page-stage"),
  comicPageImage: document.querySelector("#comic-page-image"),
  comicMagnifier: document.querySelector("#comic-magnifier"),
  comicPageEmpty: document.querySelector("#comic-page-empty"),
  comicPageLabel: document.querySelector("#comic-page-label"),
  comicPrevPage: document.querySelector("#comic-prev-page"),
  comicNextPage: document.querySelector("#comic-next-page"),
  comicZoomOut: document.querySelector("#comic-zoom-out"),
  comicZoomIn: document.querySelector("#comic-zoom-in"),
  comicZoomLabel: document.querySelector("#comic-zoom-label"),
  comicZoomSlider: document.querySelector("#comic-zoom-slider"),
  closeComicReader: document.querySelector("#close-comic-reader"),
