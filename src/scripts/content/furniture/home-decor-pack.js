...
const decorAdjustments = {
  ...
  "poor-tavern-bench": { priceCp: 220, comfort: 1 },
  "poor-ale-keg": { priceCp: 260, comfort: 1 },
  ...
  "modest-tavern-booth": { priceCp: 1400, comfort: 4 },
  "modest-mug-shelf": { priceCp: 750, comfort: 2 },
  "modest-hearth-stewpot": { priceCp: 900, comfort: 3 },
  ...
  "comfortable-carved-barstool": { priceCp: 1600, comfort: 3 },
  "comfortable-round-tavern-table": { priceCp: 2800, comfort: 5 },
  "comfortable-trophy-board": { priceCp: 2400, comfort: 4 },
  ...
  "wealthy-private-booth": { priceCp: 11000, comfort: 8 },
  "wealthy-bottle-cabinet": { priceCp: 7600, comfort: 6 },
...
const floorLevelDecor = new Set([
  ...
  "comfortable-round-tavern-table",
...
[
  ...
  ["poor-tavern-bench", "Tavern Bench", ["tavern", "inn", "bench", "seat", "wood"], { width: 2, blocksMovement: false, weight: 45, description: "A long plain bench scarred by mugs, elbows, and small-town arguments." }],
  ["poor-ale-keg", "Ale Keg", ["tavern", "inn", "drink", "keg", "barrel"], { weight: 120, description: "A stout keg with iron hoops and a tap that has seen honest use." }],
  ["camp-fireplace", "Fireplace", ["camp", "fire", "hearth", "light"], { blocksMovement: false, symbol: "F", weight: 1, components: [light(5, "#ef7b3c", 2, "camp-fire")], description: "A practical camp fireplace for warmth, cooking, and evening planning." }],
  ["inn-bar", "Inn Bar", ["tavern", "bar", "counter", "food", "drink"], { width: 4, symbol: "B", weight: 260, components: [light(4, "#f1b45d", 2, "tavern-amber")], description: "A polished inn counter with taps, mugs, stew bowls, and a patient keeper behind it." }],
...
[
  ...
  ["modest-tavern-booth", "Tavern Booth", ["tavern", "inn", "booth", "seat", "wood"], { width: 2, blocksMovement: false, weight: 95, description: "A snug wooden booth with worn cushions and a table polished by spilled ale." }],
  ["modest-mug-shelf", "Mug Shelf", ["tavern", "inn", "mug", "shelf", "drink"], { width: 2, weight: 40, description: "A wall shelf lined with mismatched mugs, tankards, and a few lucky cups." }],
  ["modest-hearth-stewpot", "Hearth Stewpot", ["tavern", "inn", "kitchen", "hearth", "food"], { blocksMovement: false, weight: 35, components: [light(3, "#d68b45", 1, "stewpot-glow")], description: "A black iron pot kept warm near the hearth, rich with whatever the inn can spare." }],
...
[
  ...
  ["comfortable-carved-barstool", "Carved Barstool", ["tavern", "inn", "bar", "stool", "seat"], { weight: 22, description: "A high stool with a carved seat, built for leaning into a good story." }],
  ["comfortable-round-tavern-table", "Round Tavern Table", ["tavern", "inn", "table", "round", "social"], { width: 2, height: 2, blocksMovement: false, weight: 80, description: "A round table broad enough for supper, dice, and four suspicious mugs." }],
  ["comfortable-trophy-board", "Trophy Board", ["tavern", "inn", "wall", "trophy", "display"], { width: 2, blocksMovement: false, description: "A board of antlers, old blades, and local hunting trophies mounted above the noise." }],
...
[
  ...
  ["wealthy-private-booth", "Private Supper Booth", ["tavern", "inn", "booth", "private", "wealthy"], { width: 2, height: 2, blocksMovement: false, description: "A curtained supper booth for quiet bargains, expensive meals, and softer cushions." }],
  ["wealthy-bottle-cabinet", "Bottle Cabinet", ["tavern", "inn", "bottle", "cabinet", "drink"], { width: 2, blocksLineOfSight: true, weight: 160, description: "A glass-front cabinet stocked with labeled bottles from roads both near and implausibly far." }],
