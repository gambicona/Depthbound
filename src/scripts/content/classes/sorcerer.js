...
window.DungeonContent.register("classes", "sorcerer", {
  ...
  spellList: ["magic_missile", "shield", "mage_armor", "burning_hands", "thunderwave", "catapult", "chaos-bolt", "color-spray", "earth-tremor", "expeditious-retreat", "false-life", "aganazzars-scorcher", "alter-self", "blindness-deafness", "blur", "earthbind", "enhance-ability", "enlarge-reduce", "gust-of-wind", "maximilians-earthen-grasp", "see-invisibility", "shadow-blade", "snillocs-snowball-swarm", "warding-wind", "blink", "daylight", "enemies-abound", "erupting-earth", "fear", "flame-arrows", "gaseous-form", "melfs-minute-meteors", "protection-from-energy", "sleet-storm", "slow", "stinking-cloud", "thunder-step", "tidal-wave", "wall-of-water", "banishment", "blight", "charm-monster", "confusion", "dimension-door", "dominate-beast", "greater-invisibility", "ice-storm", "sickening-radiance", "stoneskin", "storm-sphere", "vitriolic-sphere", "wall-of-fire", "watery-sphere", "animate-objects", "cloudkill", "cone-of-cold", "dominate-person", "enervation", "far-step", "hold-monster", "immolation", "insect-plague", "skill-empowerment", "synaptic-static", "telekinesis", "chain-lightning", "circle-of-death", "disintegrate", "eyebite", "freezing-sphere", "globe-of-invulnerability", "investiture-of-flame", "investiture-of-ice", "investiture-of-stone", "investiture-of-wind", "sunbeam", "true-seeing", "crown-of-stars", "delayed-blast-fireball", "etherealness", "finger-of-death", "fire-storm", "prismatic-spray", "reverse-gravity", "whirlwind", "horrid-wilting", "dominate-monster", "earthquake", "incendiary-cloud", "power-word-stun", "sunburst", "meteor-swarm", "power-word-kill", "psychic-scream", "scorching_ray", "mirror_image", "misty_step", "fireball", "lightning_bolt", "fly", "dispel_magic"],
  cantripList: ["mage-hand", "blade-ward", "dancing-lights", "fire-bolt", "light", "mind-sliver", "thunderclap", "chill-touch", "acid-splash", "booming-blade", "frostbite", "green-flame-blade", "poison-spray", "ray-of-frost", "shocking-grasp", "true-strike"],
  spells: [],
  token: "S",
  classFeatures: [
