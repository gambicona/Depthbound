...
window.DungeonContent.register("classes", "paladin", {
  ...
  token: "P",
  classFeatures: [
    { level: 1, name: "Lay on Hands", description: "Use a healing pool equal to 5 x paladin level to restore yourself or adjacent allies, or spend 5 points to cure one disease." },
    ...
    { level: 3, name: "Divine Health", description: "Divine magic makes you immune to disease." },
  ...
  abilities: [
    { id: "layOnHands", name: "Lay on Hands", level: 1, refresh: "longRest", uses: 5, resourcePool: "layOnHands", resource: "action", description: "Spend pool points to heal yourself or an adjacent ally, or spend 5 points to cure one disease." },
